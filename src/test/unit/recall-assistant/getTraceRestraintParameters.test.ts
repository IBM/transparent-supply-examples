  ...
  describe('ensure correct url creation', function () {
    it('should show correct URL for commission case', async function () {
      const urlRestraintParameters = getTraceConstraintParameters('urn:ibm:ift:location:loc:prefix.identifier',
        ...
        '2019-11-01',
        '2019-11-15');
      const traceCallUri = 'https://developer.transparentsupply.ibm.com/ift/api/outbound/v2/events?event_type[]=commission' +
        urlRestraintParameters;
      return expect(traceCallUri).to.equal('https://developer.transparentsupply.ibm.com/ift/api/outbound/v2/events?event_type[]='
